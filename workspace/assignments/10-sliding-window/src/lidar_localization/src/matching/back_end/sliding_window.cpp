...
bool SlidingWindow::HasNewKeyFrame() { return has_new_key_frame_; }

bool SlidingWindow::HasNewOptimized() { return has_new_optimized_; }
...
void SlidingWindow::GetOptimizedKeyFrames(
  ...
  key_frames_deque.insert(key_frames_deque.end(), key_frames_.optimized.begin(),
...
bool SlidingWindow::SaveOptimizedTrajectory() {
  ...
  if (!FileManager::CreateFile(laser_odom_ofs,
                               trajectory_path_ + "/laser_odom.txt") ||
      !FileManager::CreateFile(optimized_ofs,
                               trajectory_path_ + "/optimized.txt") ||
      !FileManager::CreateFile(ground_truth_ofs,
